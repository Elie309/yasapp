<div class="container-main">
    ...
    <div class="my-8 bg-white p-10 shadow-md rounded-md">
        ...
        $actions = [
            [
                'name' => 'Edit',
                'popovertarget' => 'EditPaymentPlans',
            ...
            [
                'name' => 'Delete',
                'popovertarget' => 'DeletePaymentPlans',
...
<div popover class="popover max-w-lg" id="EditPaymentPlans">
    <?= view_cell('App\Cells\Settings\PaymentPlan\PaymentPlanCell::render', ['formGetter' => 'edit']) ?>
</div>
,


<div popover class="popover max-w-lg" id="AddPaymentPlans" >
    <?= view_cell('App\Cells\Settings\PaymentPlan\PaymentPlanCell::render', ['formGetter' => 'add']) ?>
</div>


<div popover class="popover max-w-lg" id="DeletePaymentPlans">
    <?= view_cell('App\Cells\Settings\PaymentPlan\PaymentPlanCell::render', ['formGetter' => 'delete']) ?>
</div>
