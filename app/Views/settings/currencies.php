<div class="container-main">
    ...
    <div class="mt-8 bg-white p-10 shadow-md rounded-md">
        ...
        $actions = [
            [
                'name' => 'Edit',
                'functions' => "openModal('EditCurrencies'); setFormDetails('edit');",
            ...
            [
                'name' => 'Delete',
                'functions' => "openModal('DeleteCurrencies'); setFormDetails('delete');",
                'img' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
...
<?= view_cell('App\Cells\Utils\Modal\ModalCell::render', [
    'modalId' => 'AddCurrencies',
    'modalTitle' => 'Add Currency',
    'modalBody' => view_cell('App\Cells\Settings\Currencies\CurrenciesCell::formAdd')
]) ?>

<?= view_cell('App\Cells\Utils\Modal\ModalCell::render', [
    'modalId' => 'EditCurrencies',
    'modalTitle' => 'Edit Currency',
    'modalBody' => view_cell('App\Cells\Settings\Currencies\CurrenciesCell::formEdit')
]) ?>

<?= view_cell('App\Cells\Utils\Modal\ModalCell::render', [
    'modalId' => 'DeleteCurrencies',
    'modalTitle' => 'Delete Currency',
    'modalBody' => view_cell('App\Cells\Settings\Currencies\CurrenciesCell::formDelete')
]) ?>